...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Fig 1: Historical horses by province", out.width = '100%', out.height = '100%'}
...
knitr::kable(max_horses, caption = "Table 1. Horse Populations By Province")
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Fig 2: Historical horses in Alberta", out.width = '40%', out.height = '40%'}
